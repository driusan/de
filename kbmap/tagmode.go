...
func tagMap(e key.Event, buff *demodel.CharBuffer, v demodel.Viewport) (demodel.Map, demodel.ScrollDirection, error) {
	...
	case key.CodeReturnEnter:
		if buff.Tagline.Dot.Start == buff.Tagline.Dot.End {
			...
			actions.OpenOrPerformTagAction(position.CurTagExecutionWordStart, position.CurTagExecutionWordEnd, buff, v)
		} else {
			actions.OpenOrPerformTagAction(position.TagDotStart, position.TagDotEnd, buff, v)
		}
